...
<div class="container" style=" background-color: #1E90FF; width: 35%; padding: 20px;" >
...
<h2 style="color: #FFFFFF; text-align: center;">LOGIN</h2><br>
    <form method="POST">
        <div class="mb-3 row" style="background-color: #00008B;">
        ...
        <br>
        <div class="submit">
            <button type="submit" name="submit" class="btn" style="background-color: #00008B; color: #FFFFFF ;">Login</button>
        </div>
        <div><br><br>
