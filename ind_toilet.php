...
<body style="margin-top: 30px; background-color: #0A2647;">
    <div class="container" class="container" style="background-color: #144272; width: 50%; padding: 30px;">
        ...
        <div class="main">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF;">
                    <button class="btn" type="button" style="background-color: #FF0000; width: 70%;"><a style="color: #FFFFFF;" href="hap_toilet.php?id=<?= $row['id'];?>">Hapus Data</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #1E90FF;"><a style="color: #FFFFFF" href="tam_toilet.php">Tambah Data Toilet</a></button>
        </div> <br>
        <div>
