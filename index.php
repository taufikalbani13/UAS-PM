...
<head>
    <meta charset="UTF-8">
    <title>Database Checklist Kebersihan Toilet</title>
    <link href="style.css" rel="stylesheet" type="text/css" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-GLhlTQ8iRABdZLl6O3oVMWSktQOp6b7In1Zl3/Jr59b6EGGoI1aFkw7cmDA6j6gD" crossorigin="anonymous">

</head>
<body style="margin-top: 30px; background-color: #0A2647;">
    <div class="container" style="background-color:  #00008B; width: 250%; padding: 10px;">
        <br><br>
        <div class="head">
        ...
        <div class="main">
            ...
            <tr>
                <th style="color: #7eeef3; width: 5%;">NO</th>
            ...
            <tr>
                ...
                <td style="color: #7eeef3;">
                    <button class="btn" type="button" style="background-color: #1E90FF; width: 45%;"><a style="color: #FFFFFF;" href="ubah.php?id=<?= $row['id'];?>">Ubah Data</a></button> 
                    <button class="btn" type="button" style="background-color: #FF0000; width: 50%;"><a style="color: #FFFFFF;" href="hapus.php?id=<?= $row['id'];?>">Hapus Data</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #1E90FF;"><a style="color: #ffffff" href="tambah.php">Tambah Data Checklist</a></button>
        </div> <br>
        <div>
        <button class="btn" type="button" style="background-color: #1E90FF;"><a style="color: #FFFFFF" href="home.php">Kembali</a></button>
        </div>
    </div>
</body>
</html>